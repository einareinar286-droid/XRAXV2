    ...
    <template v-else-if="issue">
      <view class="detail-workbench">
        ...
        <view class="task-main">
          <view class="mock-banner"><text class="mock-banner-title">M2 Mock 演示</text><text>身份与数据仅保存在当前演示会话，不代表生产级鉴权或私有云存储。</text></view>
...
.evidence-item{width:100%;aspect-ratio:1;border-radius:12rpx;background:#edf2ef;overflow:hidden;display:flex;align-items:center;justify-content:center;color:$xr-green;font-size:20rpx;font-weight:700}.evidence-item image{width:100%;height:100%}
</style>
