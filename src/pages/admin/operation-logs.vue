  ...
  <view>
    ...
    <template v-else>
      ...
      <view v-if="result.items.length" class="log-list">
        <view v-for="item in result.items" :key="item.id" class="log-card glass-panel">
...
.filter-row{display:flex;align-items:center;justify-content:space-between;gap:12rpx;padding:18rpx 22rpx;border:1rpx solid $xr-line;border-radius:18rpx;background:$xr-glass-bg}
.picker,.total{font-size:23rpx;color:$xr-text}
.total{color:$xr-muted}
.reset{flex:0 0 auto;padding:0 20rpx;background:rgba(99,247,255,.12);color:$xr-green-bright;font-size:22rpx;line-height:2.2;border:1rpx solid rgba(99,247,255,.3)}
.log-list{display:flex;flex-direction:column;gap:16rpx}
.log-card{padding:24rpx;border:1rpx solid $xr-line;border-radius:20rpx;background:$xr-glass-bg}
.log-top{display:flex;align-items:center;justify-content:space-between}
.action{font-size:27rpx;font-weight:700;color:$xr-text}
.result{padding:4rpx 12rpx;border-radius:999rpx;font-size:20rpx}
.success{background:rgba(168,240,154,.12);color:$xr-lime;border:1rpx solid rgba(168,240,154,.35)}
.failure{background:rgba(255,180,171,.12);color:$xr-red;border:1rpx solid rgba(255,180,171,.4)}
.time,.meta,.note{display:block;margin-top:10rpx;font-size:21rpx;line-height:1.5;color:$xr-muted}
.note{padding-top:10rpx;border-top:1rpx solid $xr-line;color:$xr-text}
.load-more{margin-top:18rpx;text-align:center}
.load-more button{width:60%;background:rgba(99,247,255,.12);color:$xr-green-bright;font-size:23rpx;border:1rpx solid rgba(99,247,255,.3)}
