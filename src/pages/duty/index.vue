...
.task{margin-top:16rpx;padding:25rpx;border-radius:20rpx;background:$xr-glass-bg;border:1rpx solid $xr-line}
.task-top{display:flex;justify-content:space-between;align-items:center;gap:16rpx}
.status{padding:6rpx 10rpx;border-radius:8rpx;background:rgba(99,247,255,.1);color:$xr-green-bright;font-size:20rpx;border:1rpx solid rgba(99,247,255,.3)}
...
.due,.task-meta{font-size:20rpx;color:$xr-muted}
.task-title{display:block;margin:18rpx 0 7rpx;font-size:29rpx;font-weight:700;color:$xr-text}
.return-note{display:block;margin-top:14rpx;font-size:21rpx;color:$xr-red}
.return-note.pending{color:$xr-green-bright}
.state{padding:72rpx 24rpx;text-align:center;color:$xr-muted}
...
@media (min-width:1200px){.page{max-width:820px;margin:0 0 0 260px;padding:36px 32px}.title{font-size:30px}.copy,.due,.task-meta,.return-note{font-size:13px}.task{padding:22px}.task-title{font-size:19px}.status{font-size:12px}}
</style>
