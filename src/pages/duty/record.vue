...
.page{min-height:100vh;padding:30rpx 28rpx 64rpx;background:$xr-canvas}.summary,.form{padding:27rpx;border-radius:22rpx;background:$xr-surface;border:1rpx solid $xr-line}.form{margin-top:18rpx}.status{display:inline-block;padding:6rpx 10rpx;border-radius:8rpx;background:#edf3f0;color:$xr-green;font-size:20rpx}.status.submitted{background:#e8f0ff;color:#245eb4}.status.returned{background:#fff0ee;color:$xr-red}.title,.copy{display:block}.title{margin:18rpx 0 8rpx;font-size:35rpx;font-weight:740;color:$xr-text}.copy,.hint,.readonly{font-size:22rpx;color:$xr-muted;line-height:1.6}.label{display:block;margin-bottom:12rpx;font-size:26rpx;font-weight:680;color:$xr-text}.label:not(:first-child){margin-top:28rpx}textarea{box-sizing:border-box;width:100%;height:170rpx;padding:18rpx;border-radius:14rpx;background:#f2f6f3;font-size:25rpx}.files{display:flex;flex-wrap:wrap;gap:12rpx}.file,.upload{min-width:112rpx;height:88rpx;padding:10rpx;box-sizing:border-box;border-radius:12rpx;background:#eef4f1;color:$xr-green;font-size:20rpx;display:flex;align-items:center;justify-content:center;text-align:center}.upload{border:1rpx dashed $xr-line-strong;background:transparent;flex-direction:column;font-size:34rpx}.upload text{font-size:19rpx}.hint{display:block;margin-top:14rpx}.review-note{display:block;margin-top:20rpx;padding:16rpx;border-radius:12rpx;background:#fff0ee;color:$xr-red;font-size:22rpx;line-height:1.55}.primary{height:92rpx;line-height:92rpx;margin-top:22rpx;border-radius:16rpx;background:$xr-green;color:#fff;font-size:28rpx}.readonly{margin-top:22rpx;padding:20rpx;border-radius:16rpx;background:#edf3f0}@media (min-width:1200px){.page{max-width:820px;margin:0 auto;padding:36px 32px}.summary,.form{padding:25px}.status,.file,.upload{font-size:12px}.title{font-size:26px}.copy,.hint,.readonly,.review-note{font-size:13px}.label{font-size:16px}textarea{font-size:15px}.primary{height:48px;line-height:48px;font-size:15px}}
</style>
